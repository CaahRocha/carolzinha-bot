...
module.exports = {
  name: "sexo",
  description: "transa com alguem.",
  commands: ["sexo", "sexo", "sexo", "sexo"],
  ...
  handle: async ({
    ...
    if (!targetJid) {
      await sendErrorReply(
        "Você precisa mencionar um usuário ou responder uma mensagem para transar com alguem."
      );
    ...
    await sendGifFromFile(
      ...
      `@${userNumber} Transou com @${targetNumber}!`,
      [userJid, targetJid]
    );
  },
};
